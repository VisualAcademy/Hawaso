...
{
    public interface IDivisionCrudRepository<T>
        : ICrudRepositoryBase<DivisionModel, long>
    {
        /// <summary>
        /// 모델 수정
        /// </summary>
    ...
    public interface IDivisionRepository : IDivisionCrudRepository<DivisionModel>
    {
        /// <summary>
        /// 필터링 옵션에 따른 조회
        /// </summary>
        Task<ArticleSet<DivisionModel, long>> GetByAsync<TParentIdentifier>(FilterOptions<TParentIdentifier> options);
