...
namespace Hawaso.Models
{
    ...
    /// </summary>
    public interface IPurgeCrudRepository<T> : ICrudRepositoryBase<Purge, long>
    {
    ...
    /// </summary>
    public interface IPurgeRepository : IPurgeCrudRepository<Purge>
    {
        // PM> Install-Package Dul
        Task<ArticleSet<Purge, long>> GetByAsync<TParentIdentifier>(FilterOptions<TParentIdentifier> options);
