...
{
    public interface IBannedTypeCrudRepository<T> : ICrudRepositoryBase<BannedTypeModel, long>
    {
        /// <summary>
        /// 모델 수정
        /// </summary>
    ...
    public interface IBannedTypeRepository : IBannedTypeCrudRepository<BannedTypeModel>
    {
        /// <summary>
        /// 필터링 옵션에 따른 조회
        /// </summary>
        Task<ArticleSet<BannedTypeModel, long>> GetByAsync<TParentIdentifier>(FilterOptions<TParentIdentifier> options);
