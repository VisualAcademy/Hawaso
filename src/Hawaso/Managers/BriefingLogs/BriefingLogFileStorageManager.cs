...
namespace Zero.Models
{
    ...
    public class BriefingLogBlobStorageManager : IBriefingLogFileStorageManager
    {
        ...
        public BriefingLogBlobStorageManager(IConfiguration configuration)
        {
        ...
        public async Task<bool> DeleteAsync(
            string fileName,
            string folderPath = "BriefingLogs")
        {
    ...
    public class BriefingLogFileStorageManager
        : IBriefingLogFileStorageManager
    {
        private readonly IWebHostEnvironment _environment;
        private readonly string _containerName;
        private readonly string _folderPath;

        public BriefingLogFileStorageManager(
    ...
    #region BriefingLogHybridStorageManager
    ...
    /// </summary>
    public class BriefingLogHybridStorageManager
        : IBriefingLogFileStorageManager
    {
        private readonly IWebHostEnvironment _environment;
        private readonly BlobServiceClient _blobServiceClient;
        ...
        public BriefingLogHybridStorageManager(
            IWebHostEnvironment environment,
                ...
                string fileName)
        {
            ...
            while (
                await ExistsInLocalOrBlobAsync(
                    containerClient,
                    folderPath,
                    candidate))
            {
