...
namespace Zero.Models
{
    ...
    public class LibraryBlobStorageManager : ILibraryFileStorageManager
    {
        ...
        public LibraryBlobStorageManager(IConfiguration configuration)
        {
    ...
    #region LibraryHybridStorageManager
    /// <summary>
    /// 마이그레이션 기간 동안
    ...
    /// </summary>
    public class LibraryHybridStorageManager : ILibraryFileStorageManager
    {
        private readonly IWebHostEnvironment _environment;
        private readonly BlobServiceClient _blobServiceClient;
        private readonly string _containerName;
        ...
        public LibraryHybridStorageManager(
