...
{
    public PurgeBlobStorageManager()
    {
    }

    public Task<bool> DeleteAsync(string fileName, string folderPath = "Purges")
    {
        throw new NotImplementedException();
    }

    public Task<byte[]> DownloadAsync(string fileName, string folderPath = "Purges")
    {
        throw new NotImplementedException();
    }
    ...
    public Task<string> UploadAsync(byte[] bytes, string fileName, string folderPath = "Purges", bool overwrite = false)
    {
        throw new NotImplementedException();
    }

    public Task<string> UploadAsync(Stream stream, string fileName, string folderPath = "Purges", bool overwrite = false)
    {
        throw new NotImplementedException();
    }
}
